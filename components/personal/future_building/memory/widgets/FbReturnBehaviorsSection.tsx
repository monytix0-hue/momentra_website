...
type Props = { behaviors: PersonalLifeOpsReturnBehaviors };
    ...
    <section className="group flex-1" style={{ ...personalGlassCardStyle(tokens), borderRadius: 16, padding: 16 }}>
      ...
      <div className="mb-2 flex items-center justify-between">
        ...
        <div className="text-right">
          <p style={{ fontSize: 24, fontWeight: 700, color: colors.brandPrimary }}>{behaviors.roi_label.replace(/[^0-9.]/g, "").slice(0, 3) || "9.3"}x</p>
        ...
        {behaviors.bars.map((bar, i) => (
          <div
            ...
            style={{
              ...
              opacity: 0.2 + (i / Math.max(behaviors.bars.length, 1)) * 0.8,
              boxShadow: i === behaviors.bars.length - 1 ? `0 0 15px ${colors.brandPrimary}66` : undefined,
            }}
          />
        ))}
      </div>
